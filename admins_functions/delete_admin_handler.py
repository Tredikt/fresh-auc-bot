...
from blanks.bot_texts import admin_admin_isnot, admin_admin_delete, admin_text, admin_partner_wrong_format
from blanks.bot_markups import admin_markup


async def delete_admin_handler(message, state):
